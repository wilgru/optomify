...
module.exports = gql`
    ...
    type Mutation {
        ...
        createNewPatient(first_name: String!, last_name: String!, dob: String!, mobile_number: String, email: String!, has_medicare: Boolean!, medicare_number: String, medicare_ref: String, medicare_exp: String): Patient
        ...
        createNewBooking(booking_date: String!, booking_start: String!, booking_end: String!, on_patient_id: ID, booking_note: String, booking_type: String!): BookSetup
